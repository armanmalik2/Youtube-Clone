    ...
    <div>
      <div className='flex justify-between p-5'>
        ...
        <div className='flex' >
            ...
            <button className='h-10 w-16 bg-slate-400 flex items-center justify-center rounded-r-full text-2xl' onClick={()=> dispatch(searchQueri(search))}>
                <SearchIcon />
            </button>
            <div className='h-10 w-12 bg-slate-400 flex items-center justify-center ml-2 rounded-full text-2xl'>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="lucide lucide-mic-icon lucide-mic"><path d="M12 19v3"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><rect x="9" y="2" width="6" height="13" rx="3"/></svg>
            </div>
        </div>
        <div className='flex' >
            <div className='h-10 w-12 bg-slate-400 flex items-center justify-center ml-2 rounded-full text-2xl'>
